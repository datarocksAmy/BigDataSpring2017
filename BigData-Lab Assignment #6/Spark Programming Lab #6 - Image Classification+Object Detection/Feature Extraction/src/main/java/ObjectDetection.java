 ...
 * Assignment #6 - Object Detection
 * Get SIFT Features from the video and put into a vector of RDD.
 * Obtain Keyframes and set up models for each image category.
 * #20 Chia-Hui Amy Lin
 * =====================================================================
 */
...
class ObjectMainDetection {
    ...
    private MBFImage modelImage1, modelImage2, modelImage3, modelImage4, modelImage5; // Referencing for the classes
    ...
    public ObjectMainDetection() throws IOException {
        ...
        LoadReferenceObject(); // Load reference images
        StartVideo();
    }

    // Load the video ( extracting the keyframes )
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/clip.mkv"));
        int count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0;
        String o1 = "output/featuresNew.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            ...
            modelImage3 = ImageUtilities.readMBF(new File("data/sea1.jpg"));
            modelImage4 = ImageUtilities.readMBF(new File("data/peacock1.jpg"));
            modelImage5 = ImageUtilities.readMBF(new File("data/chameleon1.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
