...
# Assignment #9 - TensorFlow (CNN)
# Dataset: Project Data ( KC 3 Fountains - Children's Fountain + JC Nichols + Muse of Missouri )
# 20 Chia-Hui Amy Lin
# Reference : http://ksksksks2.hatenadiary.jp/entry/20160911/1473588581, https://github.com/apshaiTerp
# ================================================================================================================
...
labelMaster = np.ndarray(shape=(3), dtype=np.dtype('S20'))
...
# -------------------------------------------------- Train --------------------------------------------------
# Shape (total of Images = 113, Size of Image = 100*100 pixels)
allImages = np.ndarray(shape=(113, 10000))
allLabels = np.ndarray(shape=(113, 3))  # 3 Classes

testImages = np.ndarray(shape=(30, 10000))
testLabels = np.ndarray(shape=(30, 3))
...
y_ = tf.placeholder(tf.float32, [None, 3],name='y_')  # Labels for number of classes
